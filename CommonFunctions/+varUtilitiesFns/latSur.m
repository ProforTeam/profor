function result = latSur(neqs,y,x,iflag,info)
...
icnt = icnt + 1;
if icnt > itmax
warning('sur: more than %d iterations',itmax);
break;
end;
...
for i=1:neqs;
 ...
 result(i).tprob=2*tcdf(-abs(result(i).tstat),nobs-nxi(i,1));                
end;                       
